...
<!--个人已登录显示 -->
   ...
   <div class="topnavshow">
	...
	<div class="add_success">
	  ...
	  <div class="pic"><img src="../public/images/97.png" ></div>
	  
	  <div class="tipb font20">简历创建成功！</div>
	  <div class="tip font14">您的简历完整度较低，90%的企业更愿意联系完整的简历，完善后可提高8倍的求职效果！</div>
	  
	  <div class="btnsbox">
	    <div class="btnli"><div  class="qs-btn qs-btn-orange font18" onClick="javascript:location.href='<?php echo U('personal/resume_edit',array('pid'=>$resume['id']));?>'">继续完善简历</div></div>
		<div class="btnli"><div class="qs-btn qs-btn-border-blue font18" onClick="javascript:location.href='<?php echo url_rewrite('QS_jobslist');?>'">立即搜索职位</div></div>
		<div class="clear"></div>
	  </div>
	</div>
<?php if(!empty($jobslist['list'])): ?><div class="split-block"></div>

	<div class="add_successrec">
		<div class="eattitle list_height">
			你可能感兴趣的职位
			<div class="ritle font12 link_gray9"><a href="<?php echo U('Jobs/index');?>">更多</a></div>
		</div>
		<?php if(is_array($jobslist['list'])): $i = 0; $__LIST__ = $jobslist['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$jobs): $mod = ($i % 2 );++$i;?><div class="jobslist"  onClick="javascript:location.href='<?php echo ($list["jobs_url"]); ?>'">
				<div class="jname font15 link_gray6"><a href="<?php echo ($list["jobs_url"]); ?>"><?php echo ($list["jobs_name"]); ?></a></div>
				<div class="cname font12"><?php echo ($district_cn); ?> | <?php echo ($list["nature_cn"]); ?> | <?php echo ($list["experience_cn"]); ?></div>
				<div class="wage font13"><?php echo ($list["wage_cn"]); ?></div>
				<div class="time font12"><?php echo fdate($list['refreshtime']);?></div>
			</div><?php endforeach; endif; else: echo "" ;endif; ?>
	</div>
	<div class="add_successrecso link_blue">没有找到满意的职位? <a href="<?php echo U('Jobs/index');?>">立即搜索</a></div>

	<div class="split-block"></div><?php endif; ?>
