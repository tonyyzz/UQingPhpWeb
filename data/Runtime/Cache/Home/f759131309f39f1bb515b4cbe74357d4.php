	...
	<div class="tnav">
		...
		<div class="tl">
			<ul class="link_gray6 nowrap">
				<?php $tag_nav_class = new \Common\qscmstag\navTag(array('列表名'=>'nav','调用名称'=>'QS_top','显示数目'=>'10','cache'=>'0','type'=>'run',));$nav = $tag_nav_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("title"=>"{c_name} - HR工具箱","keywords"=>"","description"=>"","header_title"=>""),$nav);?>
...
<div class="hrl link_gray6">
		...
		<ul>
		<?php $tag_hrtools_list_class = new \Common\qscmstag\hrtools_listTag(array('列表名'=>'list','分类id'=>$_GET['id'],'cache'=>'0','type'=>'run',));$list = $tag_hrtools_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("title"=>"{c_name} - HR工具箱","keywords"=>"","description"=>"","header_title"=>""),$list);?>
...
<div class="footer_min" id="footer">
	...
	<?php $tag_explain_list_class = new \Common\qscmstag\explain_listTag(array('列表名'=>'list','cache'=>'0','type'=>'run',));$list = $tag_explain_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("title"=>"{c_name} - HR工具箱","keywords"=>"","description"=>"","header_title"=>""),$list);?>
