...
<script>
	var URL = '/index.php/admin/low_effi_sql',
		SELF = '/index.php?m=admin&amp;c=low_effi_sql&amp;a=index',
...
<body style="background-color:#E0F0FE">
    ...
    <div class="toptip">
		<h2>提示：</h2>
		<p>您可以通过此日志查看系统运行过程中MySQL低效查询信息。</p>
	</div>
	<table width="100%" border="0" cellpadding="0" cellspacing="0" id="list" class="link_lan">
	    <tr>
	      <td height="26" width="90"  class="admin_list_tit admin_list_first" >日志文件</td>
	      <td height="26" width="90"  class="admin_list_tit" >操作</td>
	    </tr>
	    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	      <td  class="admin_list admin_list_first"><?php echo ($vo); ?></td>
	      <td  class="admin_list"><a href="<?php echo U('detail',array('filename'=>$vo));?>">查看详情</a></td>
