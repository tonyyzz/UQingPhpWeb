...
<script>
	var URL = '/index.php/admin/personal',
		SELF = '/index.php?m=admin&amp;c=personal&amp;a=photo',
...
<div class="seltpye_y">
  ...
  <div class="list">
    ...
    <div class="txt link_lan">
      <a href="<?php echo P(array('audit'=>''));?>" <?php if($_GET['audit']== ''): ?>class="select"<?php endif; ?>>不限</a>
	    <a href="<?php echo P(array('audit'=>'2'));?>" <?php if($_GET['audit']== '2'): ?>class="select"<?php endif; ?>>等待审核<span>(<?php echo ($count[4]); ?>)</span></a>
  ...
  <div class="list">
    ...
    <div class="txt link_lan">
      <a href="<?php echo P(array('photo_audit'=>''));?>" <?php if($_GET['photo_audit']== ''): ?>class="select"<?php endif; ?>>不限(<?php echo ($count[6]); ?>)</a>
      <a href="<?php echo P(array('photo_audit'=>'2'));?>" <?php if($_GET['photo_audit']== '2'): ?>class="select"<?php endif; ?>>等待审核<span <?php if($count[7] > 0): ?>style="color:#FF0000"<?php endif; ?>>(<?php echo ($count[7]); ?>)</span></a>
      <a href="<?php echo P(array('photo_audit'=>'1'));?>" <?php if($_GET['photo_audit']== '1'): ?>class="select"<?php endif; ?>>审核通过<span>(<?php echo ($count[8]); ?>)</span></a>
      <a href="<?php echo P(array('photo_audit'=>'3'));?>" <?php if($_GET['photo_audit']== '3'): ?>class="select"<?php endif; ?>>审核未通过<span>(<?php echo ($count[9]); ?>)</span></a>
    </div>
  </div>
  <div class="list" >
...
<form id="form1" name="form1" enctype="multipart/form-data" method="post" action="<?php echo U('set_audit');?>">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="link_lan">
    <tr>
      <td class="admin_list_tit admin_list_first" >
        ...
        <td  align="center"  width="160" class="admin_list_tit">操作</td>
    </tr>
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td align="center"  class="admin_list">
          ...
          <td align="center"  class="admin_list">
            <?php if($vo['photo_audit'] == '1'): ?>审核通过<?php endif; ?>
            <?php if($vo['photo_audit'] == '2'): ?><span style="color: #FF6600">等待审核</span><?php endif; ?>
            <?php if($vo['photo_audit'] == '3'): ?><span style="color: #666666">审核未通过</span><?php endif; ?>
          </td>
          <td align="center"  class="admin_list">
  ...
  <div id="AuditSetPhoto" style="display: none" >
    <table width="400" border="0" align="center" cellpadding="0" cellspacing="6" >
      ...
      <tr>
        ...
        <td>
          <label >
            <input name="photo_audit" type="radio" value="1" checked="checked" id="success" />
          照片审核通过 </label>   </td>
        </tr>
        <tr>
          <td width="40" height="25">&nbsp;</td>
          <td width="400"><label >
            <input type="radio" name="photo_audit" value="3"  id="fail"/>
          照片审核未通过</label></td>
        </tr>
        <tr>
          <td height="25">&nbsp;</td>
          <td><span style="border-top: 1px #A3C7DA solid;">
            <input type="button" value="确定" class="set_photo_audit admin_submit">
          </span></td>
        </tr>
      </table>
    </div>
...
<div class="admin_frameset" >
  ...
  $(".ajax_send_email").QSdialog({
    ...
    $("#ButPhotoAudit").QSdialog({
    DialogAddObj:"#OpPhotoresume",
    DialogTitle:"请选择",
    DialogContent:"#AuditSetPhoto",
  ...
  DialogContent:"<?php echo U('ajax/audit_log');?>&"
    ...
    $('.set_photo_audit').live('click',function(){
      $('#form1').attr('action',"<?php echo U('set_photo_audit');?>").submit();
    });
    });
    </script>
  </body>
