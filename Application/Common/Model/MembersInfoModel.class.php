...
class MembersInfoModel extends Model{
	...
	protected $_validate = array(
		array('uid,realname,sex,birthday,residence,education,experience,phone,email','identicalNull','',0,'callback'),
		...
		array('residence','1,60','{%members_info_length_error_residence}',2,'length'),
