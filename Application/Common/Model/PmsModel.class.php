...
class PmsModel extends Model{
	protected $_validate = array(
		array('msgfrom,msgfromuid,msgtouid,msgtoname,message','identicalNull','',0,'callback'),
		array('msgfromuid,msgtouid','identicalNull','',0,'callback'),
	);
	...
	public function msg_check($ids,$user){
        ...
        //写入会员日志
		write_members_log($user,1024,$ids);
	...
	public function msg_del($ids,$user){
        ...
        if($result){
        	...
        	//写入会员日志
			write_members_log($user,1025,implode(",", $ids));
